...
import { BookOpen, Wallet, CreditCard, Sparkles, Shield, Settings2, Calendar, LayoutList, Eye, Plus, CheckCircle, Smartphone, Camera, Receipt, Calculator, StickyNote, Bell, ArrowRightLeft } from 'lucide-react';
...
export const TutorialPanel: React.FC = () => {
  const steps = [
    ...
    },
    {
      ...
      icon: <Settings2 className="text-emerald-500" size={24}/>,
      bg: "bg-emerald-500/5",
      preview: (
    ...
    <div className="p-8 space-y-8 pt-16">
      ...
      <div className="pb-12 text-center">
        <div className="flex items-center justify-center gap-2 mb-2">
           ...
           <span className="text-[8px] font-black text-slate-300 uppercase tracking-widest">App Version 3.1.0 (Build 2024)</span>
        </div>
